...
const yahooYubinData: ShippingMethod[] = [
  { name: 'ゆうパケットポストmini', size: '郵便ポスト投函可能サイズ', weight: '2kg以内', price: '160円', category: 'ゆうパケットポストmini' },
  { name: 'ゆうパケットポスト', size: '専用箱または発送用シール使用', weight: '2kg以内', price: '210円', category: 'ゆうパケットポスト' },
